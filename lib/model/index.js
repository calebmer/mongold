...
// Re-add all the native function methods because they are removed when `setPrototypeOf` is called
['apply', 'bind', 'call', 'toString'].forEach(function (method) {

  Model.prototype[method] = Function.prototype[method];
});

_.extend(Model.prototype, require('./write'), require('./read'));
